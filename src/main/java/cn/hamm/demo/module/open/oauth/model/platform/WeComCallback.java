package cn.hamm.demo.module.open.oauth.model.platform;
...
import cn.hamm.demo.module.open.oauth.OauthConfig;
...
public class WeComCallback extends AbstractOauthCallback {
    ...
    public OauthUserInfo getUserInfo(String code) {
        ...
        ServiceError.FORBIDDEN.whenNull(userId, "获取用户ID失败");
    ...
    private String getAccessToken() {
        ...
        ServiceError.FORBIDDEN.when(!StringUtils.hasText(accessToken.toString()), "AccessToken获取失败");
