...
public class PermissionController extends BaseController<PermissionEntity, PermissionService, PermissionRepository> {
    ...
    @Override
    public Json getList(@RequestBody QueryRequest<PermissionEntity> queryRequest) {
        return Json.data(Utils.getTreeUtil().buildTreeList(service.getList(queryRequest)));
    }
}
